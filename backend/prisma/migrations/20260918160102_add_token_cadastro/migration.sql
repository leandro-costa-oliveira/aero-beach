...
CREATE TABLE "TokenCadastro" (
    ...
    CONSTRAINT "TokenCadastro_usuarioId_fkey"
...
CREATE TABLE "new_Dupla" (
    ...
    CONSTRAINT "Dupla_torneioId_fkey"
        FOREIGN KEY ("torneioId")
        REFERENCES "Torneio" ("id")
        ON DELETE RESTRICT
        ON UPDATE CASCADE,

    CONSTRAINT "Dupla_participante1_fkey"
        FOREIGN KEY ("participante1")
        REFERENCES "Jogador" ("id")
        ON DELETE RESTRICT
        ON UPDATE CASCADE,

    CONSTRAINT "Dupla_participante2_fkey"
        FOREIGN KEY ("participante2")
        REFERENCES "Jogador" ("id")
        ON DELETE RESTRICT
        ON UPDATE CASCADE,

    CONSTRAINT "Dupla_categoriaId_fkey"
...
CREATE UNIQUE INDEX "Dupla_participante1_participante2_categoriaId_key"
ON "Dupla"("participante1", "participante2", "categoriaId");
...
CREATE TABLE "new_Inscricao" (
    ...
    CONSTRAINT "Inscricao_torneioId_fkey"
        FOREIGN KEY ("torneioId")
        REFERENCES "Torneio" ("id")
        ON DELETE RESTRICT
        ON UPDATE CASCADE,

    CONSTRAINT "Inscricao_jogadorId_fkey"
        FOREIGN KEY ("jogadorId")
        REFERENCES "Jogador" ("id")
        ON DELETE RESTRICT
        ON UPDATE CASCADE,

    CONSTRAINT "Inscricao_categoriaId_fkey"
        FOREIGN KEY ("categoriaId")
        REFERENCES "Categoria" ("id")
        ON DELETE SET NULL
        ON UPDATE CASCADE
...
CREATE TABLE "new_Jogador" (
    ...
    CONSTRAINT "Jogador_usuarioId_fkey"
        FOREIGN KEY ("usuarioId")
        REFERENCES "Usuario" ("id")
        ON DELETE SET NULL
        ON UPDATE CASCADE
...
CREATE UNIQUE INDEX "Jogador_usuarioId_key"
ON "Jogador"("usuarioId");

PRAGMA foreign_keys=ON;
PRAGMA defer_foreign_keys=OFF;

-- CreateIndex
CREATE UNIQUE INDEX "TokenCadastro_token_key"
ON "TokenCadastro"("token");

-- RedefineIndex
DROP INDEX "Categorias_torneioId_genero_modalidade_nivel_key";

CREATE UNIQUE INDEX "Categoria_torneioId_genero_modalidade_nivel_key"
ON "Categoria"("torneioId", "genero", "modalidade", "nivel");
